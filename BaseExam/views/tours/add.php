                ...
                <div class="full-row">
                    ...
                    <div id="itinerary-wrapper" style="background:#f8fafc;padding:12px;border-radius:8px;border:1px solid #e2e8f0;">
                        <div style="margin-bottom:8px;">
                            <button type="button" id="add-day" style="background:#06b6d4;border:none;padding:8px 12px;color:#fff;border-radius:6px;cursor:pointer;">
                                Thêm ngày
                            </button>
                        </div>
                    ...
                    <small style="color:#6b7280;display:block;margin-top:6px;">
                        Tạo số ngày mong muốn, mỗi ngày có thể thêm nhiều mốc (thời gian, địa điểm, mô tả, ảnh). Dữ liệu lưu dưới dạng JSON.
                    </small>
                </div>
            </div>
        ...
        (function() {
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:8px;">
                <div>
                    ...
                    <input type="time" class="it-time" value="${slotData.time || ''}">
                </div>
                <div>
